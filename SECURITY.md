...
- Symbolic links, Windows reparse points and junctions, lexical traversal, paths outside allowlisted roots, nested Unix mount or Windows volume boundaries, ownership anomalies and changed file identities are rejected.
