...
mod tests {
    ...
    #[test]
    fn windows_binary_candidates_cover_package_manager_shims() {
        ...
        assert!(candidates.contains(&roaming.join("npm/pi.cmd")));
        assert!(candidates.contains(&local.join("pnpm/pi.bat")));
